    ...
    >
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          {isLatest && (
            <Badge variant="outline" className="animate-pulse-subtle px-1.5 py-0">
              Latest
            </Badge>
          )}
        </div>
...
export const BlockchainViewer = ({ data }: BlockchainViewerProps) => {
  ...
  return (
    <Card className="animate-fade-in h-full flex flex-col">
      ...
      <CardContent className="flex-grow overflow-hidden flex flex-col" style={{ height: 'calc(100% - 60px)' }}>
        <div className="text-sm text-muted-foreground mb-4">
          <p>Immutable record of security events verified by blockchain</p>
        </div>
        ...
        <ScrollArea className="flex-grow relative">
          ...
          {hasMoreBlocks && (
            <div className="mt-4 text-center sticky bottom-0 pb-2 pt-4 bg-gradient-to-t from-background to-transparent">
              <button 
